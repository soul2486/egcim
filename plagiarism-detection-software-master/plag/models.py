...
class ProtectedResource(models.Model):
    ...
    order = models.ForeignKey('plag.Order', on_delete=models.CASCADE)
...
class ScanLog(models.Model):
    ...
    protected_resource = models.ForeignKey('ProtectedResource',on_delete=models.CASCADE, null=True, blank=True)
