...
class contribuable(models.Model):
     ...
     raison_social = models.CharField(max_length=200, blank=True, null=True)
     activite = models.CharField(max_length=200, blank=True, null=True)
     telephone = models.CharField(max_length=200, verbose_name='Téléphone', blank=True, null=True)
