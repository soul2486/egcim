...
def index(request):
    ...
    # import csv
    # wb=load_workbook("C:/Users/Soul/Desktop/contribuables.xlsx")
    # con = wb.active
    # i=1
    # while i < 390:
    #     newContri = contribuable.objects.create(NIU=con["A"+str(i)].value, 
    #                                                 raison_social=con["B"+str(i)].value,
    #                                                 activite=con["C"+str(i)].value,
    #                                                 regime_impot=Regime_impot.objects.get(id=con["G"+str(i)].value),
    #                                                 telephone=con["D"+str(i)].value,
    #                                                 arrondissement=con["E"+str(i)].value,
    #                                                 departement=Departement.objects.get(id=con["H"+str(i)].value),
    #                                                 ug=UG.objects.get(id=con["I"+str(i)].value),
    #                                                 sous_secteur=Sous_secteur.objects.get(id=con["J"+str(i)].value))
    #     i=i+1
    #     newContri.save
    #     print(newContri)
